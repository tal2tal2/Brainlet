...
def simulate_series(initial_var, steps, dt, use_slds=True, constant_decay=10., constant_scaling=0.0):
    """
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            for x, target in val_loader:
                ...
                val_loss = loss_mse + loss_reg + lambda_phys * physics_loss
...
for const_scaling in constant_scaling:
    ...
    for rep in range(repetitions):
        ...
        reg_loss = MSE_loss + gating_reg_loss + lambda_phys * physics_loss
        ...
        results_for_run = {
            ...
            "gating_reg_loss": gating_reg_loss,
            "reg_loss": reg_loss,
